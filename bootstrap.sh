...
#   bash <(curl -fsSL https://raw.githubusercontent.com/Johankyuk/Horus-Core/main/bootstrap.sh)
#
# Acepta los mismos flags que setup_master.sh, p.ej:
#   bash <(curl -fsSL .../bootstrap.sh) --dry-run
#
# Variables opcionales:
#   HORUS_DIR   donde clonar el repo   (default: ~/Horus-Core)
#   HORUS_REF      rama o tag a clonar     (default: main)
set -euo pipefail

REPO_URL="https://github.com/Johankyuk/Horus-Core.git"
DEST="${HORUS_DIR:-$HOME/Horus-Core}"
REF="${HORUS_REF:-main}"
